...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form style="background: rgba(77,107,128,0.57); top: 50%; left: 45%; width: auto; margin-top: 60px;" onsubmit="preventDefault()" class="box">
<h1 style="color: black">Downloads</h1>

<h2 style="color: white">86 (the band) - True Life Songs and Pictures</h2>
    ...
    <tr>
        ...
        <td>
            <audio controls autoplay name="media" controlsList="nodownload">  <%--controlsList="nodownload" không cho tải trong trình phát--%>
                <source src="<c:url value='/musicStore/star2.mp3'/>" type="audio/mp3">
            </audio>
        </td>
        <td>  <%--<c:url value='/musicStore/sound/8601/start3.mp3'/>--%>
            <a href="<c:url value='/musicStore/star2.mp3'/>" target="_blank"
